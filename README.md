...
本期已实现 **生日与提醒** 相关能力，包含主题换肤、家人生日录入、提醒规则、多渠道提醒、日程页与消息中心等。功能说明与截图详见：

**[生日与提醒功能 · 本期更新说明](./docs/birthday-reminder-features.md)**
...
> 详细说明：[birthday-reminder-features.md](./docs/birthday-reminder-features.md)
...
- 项目根目录为 `Roomie/`
- 请在 `manifest.json` 与 `common/config/index.ts` 中将 `wxYOUR_WECHAT_APPID` 替换为你的微信小程序 AppID
...
### 3. 查看本期新功能
- 阅读 [生日与提醒功能说明](./docs/birthday-reminder-features.md) 了解本期已实现能力与界面截图
...
> 本期功能详情：[birthday-reminder-features.md](./docs/birthday-reminder-features.md)

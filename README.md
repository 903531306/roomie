...
- 支持 `.csv` / `.xlsx`，页面内提供官方导出路径指引
- 自动识别 **重复交易**，避免重复入账
- 导入前可修改 **分类**、**支付方式**
- **待检查** 提示、**同商户批量改分类**、**记住商户规则**
- 导入完成后展示成功 / 重复 / 跳过 / 失败统计

📖 **用户使用说明（含界面截图）**：[docs/ledger-import-features.md](./docs/ledger-import-features.md)

### v2.0 · 生日与提醒

本期已实现 **生日与提醒** 相关能力，包含主题换肤、家人生日录入、提醒规则、多渠道提醒、日程页与消息中心等。

📖 **功能说明**：[docs/birthday-reminder-features.md](./docs/birthday-reminder-features.md)
...
- 解析预览、重复识别、分类与支付方式编辑
- 详见 [账单导入使用说明](./docs/ledger-import-features.md)
...
### 3. 查看功能说明
- [账单导入使用说明](./docs/ledger-import-features.md) — v2.1 最新，含导入步骤与界面截图
- [生日与提醒功能说明](./docs/birthday-reminder-features.md) — v2.0，含主题换肤与提醒能力
...
- [x] **账单导入**（微信 / 支付宝，预览确认入库）→ [使用说明](./docs/ledger-import-features.md)
